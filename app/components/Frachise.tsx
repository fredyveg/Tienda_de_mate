    ...
    <div className="bg-white min-h-screen flex flex-col items-center py-10 px-4">
      <main className="w-full max-w-3xl bg-transparent rounded-lg shadow-none p-6">
        ...
        <div className="text-center mb-6">
          <div className="text-lg text-secundario-300 text-opacity-0.5 font-light">
            <span>{`CONOCÉ TODAS LAS OPCIONES`}</span>
          </div>

          <div className="mt-3 mb-4">
            <strong className="text-3xl font-bold text-primario-400">
              CONVERTITE EN FRANQUICIADO{" "}
            </strong>
          </div>

          <div
            className="bg-secundario-300 h-0.5 w-16 mx-auto"
            style={{height: "0.15rem"}}
          />

          <div className="mt-3">
            <span className="text-primario-400">
              Querés ser parte de este equipo? Dejanos tus datos para recibir
              mas información, y nos pondremos en contacto para contarte todas
              las posibilidades de tu próxima franquicia Tienda de Mate!
            </span>
          </div>
        </div>
        ...
        <form className="mt-8 space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <InputField
              placeholder="¿En qué zona te interesaría instalar la franquicia?"
              type="text"
            />
          </div>
