    ...
    >
      {PRODUCTOS.map((product) => (
        ...
        >
          ...
          <div
            className={`absolute inset-0 ${product.color} bg-opacity-100 flex items-start justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg px-10 py-5 m-4 h-[80%]`}
          >
