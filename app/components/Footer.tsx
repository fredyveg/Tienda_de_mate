    ...
    <footer>
      <Card className="rounded-none">
        <CardBody className="flex flex-col bg-primario-500 px-0">
          <div className="flex flex-col sm:flex-row w-full sm:justify-between gap-5 sm:gap-0 py-10 px-4 sm:px-20 xl:px-56 text-center sm:text-start">
          ...
          <div className="flex flex-col text-blanco/70 text-xs font-thin gap-1 pt-4 pb-2 px-4 sm:px-20 xl:px-56 text-center sm:text-start">
